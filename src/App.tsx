      ...
      <div className="bg-gradient-to-r from-black px-8 py-16">
          <div className=" max-w-xl grid grid-cols-1 gap-8">
            ...
            <h2 className="text-6xl font-bold">
              NOMBRE DEL ALUMNO: Erik Osvaldo Chavez Garcia
            </h2>
            <h1 className="text-6xl font-bold">
              CUENTA GIT: https://github.com/Erik2chavez/actividad
            </h1>
            <h1 className="text-6xl font-bold">
              CUENTA GIT LAB: https://gitlab.com/erik2chavez
            </h1>
            <h1 className="text-6xl font-bold">
              E-MAIL: erik2chavez@gmaill.com
            </h1>                      
          </div>
        </div>
     </div>
